...
<body onload="myFunction()" style="margin: 0;">
	...
	<div class="container-fluid">
		...
		<div class="table-responsive">
			...
			<form:form method="POST" action="uploadZipFile?${_csrf.parameterName}=${_csrf.token}" modelAttribute="fileModel"
				enctype="multipart/form-data">
				<table>
					<tr>
						<td><label >Select a file to upload</label></td>
						<td><input type="file" name="file"  accept="application/zip"/></td>
					</tr>
					<tr>
